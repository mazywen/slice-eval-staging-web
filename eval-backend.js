(() => {
  ...
  const EXPECTED = Object.freeze({
    ...
    evalActivateActivityCandidate: ['POST', '/eval-api/v1/runs/{runId}/activity-candidates/{candidateId}/activate', 201, 'compiler_runtime_eval_bearer', 'compiler_runtime_eval', 'required'],
  ...
  const OPERATION_STAGES = Object.freeze({
    ...
    evalActivateActivityCandidate: 'runtime',
